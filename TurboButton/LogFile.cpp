...
bool LogFile::OpenLogFile(QString username)
{
...
void LogFile::OpenLog(QString name)
{
...
bool LogFile::FileExists(QString filename)
{
...
void LogFile::Log(QString name, QString value, QString status)
{
    if (!mOut && !mOut.is_open())
    {
        return;
...
void LogFile::LogPanicStarted(int seconds)
{
    if (!mOut && !mOut.is_open())
    {
        return;
...
void LogFile::LogPanicAdjusted(int seconds)
{
    if (!mOut && !mOut.is_open())
    {
        return;
