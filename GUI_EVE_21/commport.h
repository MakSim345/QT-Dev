...
#define COMFILE_VERSION "RELEASE: IRIS_EDU02_0_4 \n\r"
...
public:
   enum Parity
	...
	void SetRecBytes(int i) {m_lGenRecBytes = m_lGenRecBytes+i;}
	void SetSenBytes(int i) {m_lGenSenBytes = m_lGenSenBytes+i;}

	int  GetBufferSizeVar(void) {return m_nBufferSize;}
	long GetRecBytes(void) {return m_lGenRecBytes;}
	long GetSenBytes(void) {return m_lGenSenBytes;}	 

	HANDLE* GetComPortHandle(void) {return &m_hCom;}
