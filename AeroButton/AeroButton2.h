#ifndef _AeroButton2_
#define _AeroButton2_
...
class AeroButton2 : public QPushButton
{
	Q_OBJECT

public:
	AeroButton2(QWidget * parent = 0);
	AeroButton2(const QString & text, QWidget * parent = 0);
	AeroButton2(const QIcon & icon, const QString & text, QWidget * parent = 0);
