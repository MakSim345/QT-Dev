...
**
** Created: Thu 21. Aug 11:02:29 2008
...
public:
    ...
    pushButton_14->setGeometry(QRect(870, 650, 171, 51));
    ...
    IDC_InformBox->setGeometry(QRect(380, 680, 471, 21));
    ...
    QWidget::setTabOrder(IDC_ExhFlowMinus2, IDC_COM_NUMBER);
    QWidget::setTabOrder(IDC_COM_NUMBER, IDC_COM_SPEED);
    QWidget::setTabOrder(IDC_COM_SPEED, IDC_TotalFlowResult);
    QWidget::setTabOrder(IDC_TotalFlowResult, IDC_ExhalFlow);
    QWidget::setTabOrder(IDC_ExhalFlow, IDC_O2Percents);
    ...
    QWidget::setTabOrder(IDC_ExhalFlow2, IDE_Exit);
    QWidget::setTabOrder(IDE_Exit, IDC_TCTemp);
    ...
    QWidget::setTabOrder(IDC_ExhFlowSteps2, pushButton_6);
    QWidget::setTabOrder(pushButton_6, editTotalFlow_7);
    QWidget::setTabOrder(editTotalFlow_7, editTotalFlow_8);
    QWidget::setTabOrder(editTotalFlow_8, editTotalFlow_9);
    QWidget::setTabOrder(editTotalFlow_9, pushButton_7);
    QWidget::setTabOrder(pushButton_7, IDC_DitherDAC);
    ...
    QWidget::setTabOrder(IDC_EXHVLV_CNTRL, pushButton_12);
    QWidget::setTabOrder(pushButton_12, pushButton_14);
    QWidget::setTabOrder(pushButton_14, IDC_InformBox);
