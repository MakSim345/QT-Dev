...
BelowsEnh::BelowsEnh(QWidget *parent) : QWidget(parent)
{
...
void BelowsEnh::setValueDim(int dim)
{
    dimVal = dim;
    update();
}

void BelowsEnh::setColorBg(QColor color)
{
    colBack = color;
    update();
}

void BelowsEnh::setColorValue(QColor color)
{
    colValue = color;
    update();
}

void BelowsEnh::setColorHigh(QColor color)
{
    colHigh = color;
    update();
}
...
void BelowsEnh::setColorLow(QColor color)
{
    colLow = color;
    update();
}

void BelowsEnh::setProgrBarValue(int nVal)
{
 setLeftValue(nVal); 
}

void BelowsEnh::setLeftValue(double leftValue)
{
    if (leftValue > max)
    {
        leftVal = max;
...
void BelowsEnh::setRightValue(double rightValue)
{
    if (rightValue > max)
    {
        rightVal = max;
...
void BelowsEnh::setMinValue(double minValue)
{
    if (minValue > max)
    {
        min = max;
...
void BelowsEnh::setMaxValue(double maxValue)
{
    if (maxValue < min)
    {
        max = min;
...
QSize BelowsEnh::minimumSizeHint() const
{
    return QSize(100, 300);
}

QSize BelowsEnh::sizeHint() const
{
    return QSize(100, 300);
}
